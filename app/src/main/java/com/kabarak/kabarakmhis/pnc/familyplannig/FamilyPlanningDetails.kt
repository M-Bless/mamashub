...
import com.kabarak.kabarakmhis.R.id.detailsRecyclerView
...
import com.kabarak.kabarakmhis.pnc.familyplannig.FamilyPlanningDetailsAdapter
...
class FamilyPlanningDetails : AppCompatActivity() {

    private lateinit var retrofitCallsFhir: RetrofitCallsFhir
    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: FamilyPlanningDetailsAdapter
    private val detailsList = mutableListOf<QuestionnaireDetails>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_family_planning_details)

        retrofitCallsFhir = RetrofitCallsFhir()
        recyclerView = findViewById(detailsRecyclerView)
        recyclerView.layoutManager = LinearLayoutManager(this)
        adapter = FamilyPlanningDetailsAdapter(detailsList) { responseId ->
        ...
        editButton.setOnClickListener {
            val intent = Intent(this, FamilyPlannigEdit::class.java)
